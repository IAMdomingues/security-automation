...
Me especializo en fortalecer la postura de seguridad de las organizaciones a través del **Gobierno de Identidades (IGA)** y la automatización de procesos críticos. Mi objetivo es reducir el riesgo operacional mediante el uso estratégico de **PowerShell** y herramientas de gestión moderna de Microsoft.

---

### 🧠 Sobre Mí / About Me
- 🎯 **Enfoque Profesional:** Gestión de Identidades (Entra ID), Seguridad de Endpoints (Intune) y cumplimiento normativo.
- 🔐 **Ciberseguridad:** **ISC2 Candidate**. Comprometida con los principios de **Zero Trust** y Mínimo Privilegio.
- 🛠️ **Automatización:** Desarrollo de scripts para la gestión del ciclo de vida del usuario (Joiner-Mover-Leaver) y auditorías de seguridad.
- 💬 **Idiomas:** Portugués (Nativo), Español (Avanzado), Inglés (Intermedio Técnico).
...
- **Compliance:** Conocimientos en ISO 27001, PCI DSS y SOC 2.
...
- **Email:** sarahddomingues@outlook.com
